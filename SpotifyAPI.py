...
class SpotifyAPI(object):
    ...
    def get_playlist_resource(self,lookup_id, resource_type='playlists',version='v1'):
    ...
    def search(self,  search_type='track', query=None, operator=None, operator_query=None):
        if query == None:
    ...
    def get_playlist_tracks(self,_id):
        return self.get_playlist_resource(_id)
